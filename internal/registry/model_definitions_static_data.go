...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Description:         "High-capacity reasoning variant of GPT 5.4.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
		},
		{
			...
			Description:         "Coding-specialized variant of GPT 5.4.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
		},
		{
			...
			Type:                "openai",
			Version:             "gpt-5.4",
			DisplayName:         "GPT 5.4 Codex Spark",
			Description:         "Ultra-fast coding variant of GPT 5.4.",
			ContextLength:       128000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
