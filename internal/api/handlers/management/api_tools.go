...
const (
	geminiOAuthClientID     = "YOUR_GOOGLE_OAUTH_CLIENT_ID"
	geminiOAuthClientSecret = "YOUR_GOOGLE_OAUTH_CLIENT_SECRET"
)
...
const (
	antigravityOAuthClientID     = "YOUR_GOOGLE_OAUTH_CLIENT_ID"
	antigravityOAuthClientSecret = "YOUR_GOOGLE_OAUTH_CLIENT_SECRET"
)
